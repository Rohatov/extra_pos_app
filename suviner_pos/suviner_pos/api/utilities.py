...
from suviner_pos.utils import get_build_version
...
def get_available_languages():
    ...
    try:
        translations_path = frappe.get_app_path("suviner_pos", "translations")
        if os.path.exists(translations_path):
...
def get_language_info(lang_code):
    ...
    try:
        ...
        translations_path = frappe.get_app_path("suviner_pos", "translations", f"{lang_code}.csv")
