"""Utility helpers shared across the Suviner POS backend."""
...
from suviner_pos import __version__ as app_version

_BASE_DIR = Path(__file__).resolve().parent
_VERSION_FILE = _BASE_DIR / "public" / "dist" / "js" / "version.json"
_CSS_FILE = _BASE_DIR / "public" / "dist" / "js" / "suviner_pos.css"
