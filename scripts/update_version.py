#!/usr/bin/env python3
"""Update project version in package.json and suviner_pos/__init__.py."""
import json
import re
...
def replace_version_in_init(version: str) -> None:
    init_path = Path("suviner_pos/__init__.py")
...
def replace_version_in_package_json(version: str) -> None:
    # Frontend olib tashlangan — package.json endi yo'q; bo'lsa yangilaymiz
